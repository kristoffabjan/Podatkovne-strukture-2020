...
public class BinomialHeap {
	...
	public boolean delMin() {
		BinomialNode toBeDeleted = getMinNode();
		BinomialNode[] newArr = data;
		//shranimo otroke, ki jih bomo mergali v data
		Vector<BinomialNode> temp;
		temp = toBeDeleted.childs;
		//pobrisemo element na mestu
		newArr[toBeDeleted.childs.size()] = null;
		for (int i = 0; i < temp.size(); i++) {
			//vstavimo drevesa iz indeksa v data
			data = mergeHeaps(new BinomialHeap(temp.elementAt(i)));
		}
		return true;
	}
